...
export default function Home() {
  const stats = [
    ...
    { number: "1000+", label: "משחקים" },
    { number: "50+", label: "שירים" },
  ];

  const features = [
    { icon: "🎵", title: "שירים", description: "אוסף של שירי הפועל", href: "/songs" },
    { icon: "⚽", title: "משחקים", description: "ארכיון משחקים", href: "/matches" },
    { icon: "👕", title: "חולצות", description: "גלריה של חולצות", href: "/jerseys" },
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 gap-8">
            {features.map((feature, i) => (
              <Link key={i} href={feature.href} className="bg-white p-8 rounded-lg shadow hover:shadow-lg hover:translate-y-[-4px] transition">
